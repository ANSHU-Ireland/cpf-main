...
export const ORG_PERMISSIONS: readonly Permission[] = [
  ...
  { role: CANDIDATE_ROLE, action: 'read', resourceType: 'candidate' },
  { role: CANDIDATE_ROLE, action: 'write', resourceType: 'candidate' },
  { role: CANDIDATE_ROLE, action: 'read', resourceType: 'application' },
  { role: CANDIDATE_ROLE, action: 'write', resourceType: 'application' },
  { role: CANDIDATE_ROLE, action: 'read', resourceType: 'accommodation' },
  { role: CANDIDATE_ROLE, action: 'write', resourceType: 'accommodation' },
  { role: CANDIDATE_ROLE, action: 'read', resourceType: 'notice_acknowledgement' },
  { role: CANDIDATE_ROLE, action: 'write', resourceType: 'notice_acknowledgement' },
  { role: CANDIDATE_ROLE, action: 'read', resourceType: 'data_rights_request' },
  { role: CANDIDATE_ROLE, action: 'write', resourceType: 'data_rights_request' },
  { role: CANDIDATE_ROLE, action: 'write', resourceType: 'complaint' },
  { role: CANDIDATE_ROLE, action: 'read', resourceType: 'booking' },
  { role: CANDIDATE_ROLE, action: 'write', resourceType: 'booking' },
  ...
  { role: GOVERNANCE_OFFICER_ROLE, action: 'write', resourceType: 'ai_system' },
  { role: GOVERNANCE_OFFICER_ROLE, action: 'read', resourceType: 'risk_control' },
  { role: GOVERNANCE_OFFICER_ROLE, action: 'write', resourceType: 'risk_control' },
  { role: GOVERNANCE_OFFICER_ROLE, action: 'read', resourceType: 'governance_doc' },
  { role: GOVERNANCE_OFFICER_ROLE, action: 'write', resourceType: 'governance_doc' },
  { role: GOVERNANCE_OFFICER_ROLE, action: 'read', resourceType: 'governance_submission' },
  { role: GOVERNANCE_OFFICER_ROLE, action: 'write', resourceType: 'governance_submission' },
  { role: GOVERNANCE_OFFICER_ROLE, action: 'read', resourceType: 'deployer_readiness' },
