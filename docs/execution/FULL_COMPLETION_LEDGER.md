...
Publication update: canonical governance documents and audit collection/traceability persistence
are now implemented locally, with verification recorded in `GITHUB_CHECKPOINT_2026-09-05.md`.
Programme stages below remain unchanged: publishing this checkpoint does not close CPF-05–12,
CPF-14 or CPF-15. The additional 360 traceability fixtures cover only 12 unique requirement keys.
...
| PostgreSQL baseline       | 139 physical / 138 logical; current 144 / 143 | migration/schema facts, RLS and repository coverage            |
...
| CPF-07 | Wire 244 OpenAPI operations to concrete handlers              | In progress | executable classification test covers 244/244; candidate merge preview and plural governance-document mappings are fixed; operation-specific semantic/E2E proof remains                  |
| CPF-08 | PostgreSQL repositories and transaction/outbox coverage       | In progress | full live checkpoint: 178 files / 1,657 tests; all 13 governance-document families now have canonical, audited, tenant-negative live evidence                                            |
...
| CPF-13 | Deterministic PostgreSQL UAT seed                             | Complete    | idempotent seed creates 30 organizations, 120 campaigns, 360 applications, 390 canonical governance documents and 242 reset-required credentials; changed passwords survive reseed       |
...
| CPF-15 | Deployment/IaC/operations and controlled-pilot package        | In progress | AWS/runtime-role CI is green; HTTPS coherence, immutable release migration, post-deploy UAT, monitoring and runbooks are authored; AWS apply and operational drills remain external      |
